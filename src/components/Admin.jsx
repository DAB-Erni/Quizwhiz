      ...
      <div className="cont w-full h-full md:h-screen bg-slate-700 pt-[140px] py-14 px-4 flex items-center relative">
        <div className="mx-auto w-full max-w-[343px] h-auto bg-primary opacity-70 rounded-2xl flex flex-col justify-start px-4 py-8 text-center gap-5 md:w-full md:max-w-[768px] lg:max-w-[1080px]">
                ...
                <div className="flex gap-2 w-full md:w-1/3 lg:w-1/4">
                  ...
                  <div className="bg-secondary gap-6 flex flex-col justify-center items-center rounded-lg py-5 px-3 w-full">
                    ...
                    <div className="flex gap-1">
                        <Link to="/examiner">
                        <button className="font-normal text-xs w-full text-tertiary border-tertiary border-2 flex justify-center gap-2 items-center text-md px-8 py-3 rounded hover:bg-tertiary hover:text-light focus:outline-none focus:ring focus:ring-blue-300">View Test</button>    
                        </Link>
                    </div>
                  </div>
                </div>
          ...
          <Link to="/">
                  <button
                  type="submit"
                  className="w-full max-w-[250px] btn-bg text-white py-3 rounded hover:bg-blue-600 focus:outline-none focus:ring focus:ring-blue-300"
                  >
                  + Create a New Quiz
                  </button>
                </Link>
